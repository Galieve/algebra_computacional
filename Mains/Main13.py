...
print "la base de Grobner es:", S.buchberger_algorithm(lp), "y la reducida es:", S.minimal_reduced_buchberger_algorithm(lp)
...
print "la base de Grobner es:", U.buchberger_algorithm(lp), "y la reducida es:", U.minimal_reduced_buchberger_algorithm(lp)
